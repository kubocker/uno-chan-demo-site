  ...
  preflights: [
    {
      getCSS: ({ theme }) => `
        ...
        @keyframes rollOut { 0% { opacity: '1'; transform: 'translateX(0) rotate(0deg)'; } 100% { transform: 'translateX(100%) rotate(120deg)'; opacity: '0'; } }
        ...
        @keyframes zoomInUp { 0% { opacity: '0'; transform: 'scale(0.1) translateY(100%)'; } 100% { transform: 'scale(1) translateY(0)'; } }
        @keyframes zoomInLeft { 0% { opacity: '0'; transform: 'scale(0.1) translateX(-100%)'; } 100% { transform: 'scale(1) translateX(0)'; } }
        @keyframes zoomInRight { 0% { opacity: '0'; transform: 'scale(0.1) translateX(100%)'; } 100% { transform: 'scale(1) translateX(0)'; } }
